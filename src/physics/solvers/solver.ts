 ...
 */
export type CollisionSolver = (m: Manifold, delta?: number, currIteration?: number, maxIterations?: number) => void;
...
export type ConstraintSolver = (constraint: Constraint, delta?: number) => void;
